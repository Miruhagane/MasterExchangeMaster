...
namespace WebApplication2.Arqueos
{
    public partial class arqueocierre : System.Web.UI.Page
    {
        ...
        private void obtcantidades()
        {
            ...
            SqlDataAdapter compras = new SqlDataAdapter("select a.Lng_IdCierre, b.Num_Denominacion, a.Dbl_Cantidad from Tb_Cierre as a inner join Ct_Denominaciones as b on a.Int_IdDenomicacion = b.Int_IdDenominacion where a.Int_IdStatus = 1 and a.Int_IdUsuario = " + userid + " and a.Int_IdSucursal = " + sucursalid + " and  a.Bol_Congelar = 0", con);
        ...
        private void actualizarcantidad()
        {
            ...
            for (int b = 0; b < 10; b++)
            {
                ...
                SqlCommand inser1 = new SqlCommand("UPDATE [dbo].[Tb_Cierre] SET [Dbl_Cantidad] = " + valoredenominacion[valor] + ", Bol_Congelar = 0 WHERE Lng_IdCierre = " + IdCierre[valor] + " and Int_IdUsuario = " + userid + " and  Int_IdSucursal = " + sucursalid + " ", conectorbd);
                conectorbd.Open();
