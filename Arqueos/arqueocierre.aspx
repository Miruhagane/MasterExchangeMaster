...
<body>
    <form id="form1" runat="server" class="row">
        ...
        <div class="col-sm-12">
                                         ...
                                         <div class="col-sm-6">
                                             <asp:GridView ID="Tb_arqueofinal" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="Lng_IdCierre" ForeColor="Black" GridLines="Vertical">
