        ...
        <div id="administrativo">
            <div class="form-row">
                            ...
                            <asp:DropDownList  class="custom-select" ID="Cajero1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Txt_NomCorto" DataValueField="Int_Idusuario"></asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:masterexchangeserver %>" SelectCommand="SELECT [Int_Idusuario], [Txt_NomCorto] FROM [Tb_Usuarios]"></asp:SqlDataSource>
